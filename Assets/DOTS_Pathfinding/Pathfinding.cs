...
public class Pathfinding : MonoBehaviour {
    ...
    private void Start() {
        FunctionPeriodic.Create(() => {
            ...
            NativeArray<JobHandle> jobHandleArray = new NativeArray<JobHandle>(1, Allocator.TempJob);
    ...
    private struct FindPathJob : IJob {
        ...
        public void Execute() {
            ...
            // Place Testing Walls
            {
                PathNode walkablePathNode = pat hNodeArray[CalculateIndex(1, 0, gridSize.x)];
